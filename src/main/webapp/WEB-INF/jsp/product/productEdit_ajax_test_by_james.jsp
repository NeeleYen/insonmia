...
//      	      htmlstring += 
//      	      "<img width='300px' src='http://localhost:8081/my-app/house/image?photoId=" + data[i] + "' />"
//      	     }
      //
...
//      	public ResponseEntity<byte[]> getHouseImage(@RequestParam Integer photoId){
//      		 Optional<HousePhoto> optional = housePhotoDao.findById(photoId);
//      		 
