...
$(function(){
	...
	let ws = new WebSocket('ws://localhost:8080/ws/instant-chat');
	//伺服端對於/instant-chat請求路徑的對應的websocket-handler是設定在ws/src/main/resources/springmvc-servlet.xml的spring-mvc組態檔裡面。
